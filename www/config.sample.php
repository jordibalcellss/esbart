...
define('LDAP_USER_ATTRS', 'givenname,cn,uid,mail,telephoneNumber,radiusSimultaneousUse,radiusTunnelPrivateGroupId,radiusExpiration');
...
define('LDAP_GROUPS_DN','ou=groups,'.LDAP_TREE);
define('LDAP_AUTH_GROUP','cn=admin,'.LDAP_GROUPS_DN);
