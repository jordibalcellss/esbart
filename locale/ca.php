...
define("add","afegeix");
define("list_action","llista");
define("disable","desactiva");
define("edit","edita");
define("repeat","repetiu");
define("create","crea");
define("save","salva");
define("was_disabled","s'ha desactivat");

define("name","nom");
define("surname","primer cognom");
define("surname_2","segon cognom");
define("login","login");
define("email","correu-e");
define("id","id");
define("home_directory","directori d'usuari");
define("shell","intèrpret d'ordres");
define("member_of","membre de");
...
define("group_naming_advice","es recomana que no tinguin espais ni caràcters especials");

define("user_add_how_to_use","com usar el formulari");
define("user_add_advice_1","només el nom i el nom d'usuari són requerits");
define("user_add_advice_2","un directori d'usuari buit s'estableix sota /home automàticament");
define("user_add_assisted_advice_1","ompliu el nom, primer cognom i segon cognom");
define("user_add_assisted_advice_2","si no sabeu el segon cognom, deixeu-lo buit");
define("user_add_assisted_advice_3","fixeu-vos bé en el correu-e de l'usuari, ja que es on rebrà la informació de benvinguda");
